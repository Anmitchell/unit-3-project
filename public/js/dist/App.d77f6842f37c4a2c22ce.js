...
}`, "",{"version":3,"sources":["webpack://./src/components/Logo/Logo.module.scss"],"names":[],"mappings":"AAAA;EACI,cAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;EACA,8BAAA;EACA,mBAAA;EACA,kBAAA;EACA,kCAAA;AACJ","sourcesContent":[".Logo {\n    height: 12vmin;\n    width: 12vmin;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    border-radius: 50%;\n    background-color: var(--peach);\n    color: var(--white);\n    font-size: 2.7vmin;\n    border: .6vmin solid var(--white);\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
}`, "",{"version":3,"sources":["webpack://./src/components/MenuList/MenuList.module.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,WAAA;EACA,aAAA;EACA,6BAAA;EACA,eAAA;EACA,8BAAA;AACJ","sourcesContent":[".MenuList {\n    height: 100vh;\n    width: 100%;\n    display: flex;\n    justify-content: space-evenly;\n    flex-wrap: wrap;\n    background-color: var(--white);\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.xw8qBkbk_qLDD8Jt0Bf8 li.KhlIrWtBku5AR98kJvgi {
  background-color: var(--peach);
}`, "",{"version":3,"sources":["webpack://./src/components/Navbar/Navbar.module.scss"],"names":[],"mappings":"AAAA;EACI,6BAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,SAAA;EACA,kBAAA;AACJ;;AAEA;EACI,gBAAA;EACA,WAAA;EACA,UAAA;EACA,SAAA;EACA,aAAA;EACA,8BAAA;EACA,oBAAA;EACA,SAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;AACJ;;AAEA;EACI,8BAAA;EACA,eAAA;EACA,mBAAA;AACJ;;AAEA;EACI,8BAAA;AACJ","sourcesContent":[".nav {\n    background-color: var(--grey);\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    gap: 2rem;\n    padding: 1rem 1rem;\n}\n\n.ul {\n    list-style: none;\n    width: 100%;\n    padding: 0;\n    margin: 0;\n    display: flex;\n    justify-content: space-between;\n    align-items: stretch;\n    gap: 3rem;\n    padding: 0 1rem;\n    font-size: 30px;\n    font-weight: 800;\n}\n\n.nav li:hover {\n    background-color: var(--peach);\n    cursor: pointer;\n    color: var(--white)\n}\n\n.nav li.active {\n    background-color: var(--peach);\n}\n\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
