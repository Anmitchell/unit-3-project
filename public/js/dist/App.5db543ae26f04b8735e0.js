...
___CSS_LOADER_EXPORT___.push([module.id, `.xw8qBkbk_qLDD8Jt0Bf8 {
  ...
  gap: 2rem;
  padding: 0 1rem;
}`, "",{"version":3,"sources":["webpack://./src/components/Navbar/Navbar.module.scss"],"names":[],"mappings":"AAAA;EACI,6BAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,SAAA;EACA,eAAA;AACJ","sourcesContent":[".nav {\n    background-color: var(--grey);\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    gap: 2rem;\n    padding: 0 1rem;\n  }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
/******/ })()
;
//# sourceMappingURL=App.eb62ebc60503023cd187bfba4fdd56cf.js.map