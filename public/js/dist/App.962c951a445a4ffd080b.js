    ...
    */
    ...
    function _addGuest() {
      _addGuest = _asyncToGenerator(function* () {
        ...
        const createdGuestToken = yield (0,_utilities_users_api__WEBPACK_IMPORTED_MODULE_6__.createGuest)(guest).then(token => {
          const payload = JSON.parse(atob(token.split('.')[1])).user;
        });
        setUser(guest);
      });
      return _addGuest.apply(this, arguments);
...
/******/ })()
;
//# sourceMappingURL=App.53d6c789eb763f40f7e315c497e46cea.js.map